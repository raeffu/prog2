...
public class BankData {
  ...
  public BankAccount read(int n) throws IOException {
    ...
    float interestRate = file.readFloat();
    String owner = file.readUTF();
    return new BankAccount(accountNumber, balance, interestRate, owner);
  }
  ...
  public void write(int n, BankAccount account) throws IOException {
    ...
    file.writeFloat(account.getInterest());
    file.writeUTF(account.getOwner());
  }
}
